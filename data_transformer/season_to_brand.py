...
def season_to_brand(data):
    ...
    try:
        ...
        logger.info('Season-to-brand update query failed - rolling up with existing season-to-brand map')
    ...
    # drop all episode/season missed matches as player can only return brands anyway
    data = data[data['BRAND_GUID'].notnull() | ((data['type'] != 'season') & (data['type'] != 'episode'))]
